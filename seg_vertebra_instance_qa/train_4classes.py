...
def train(model, train_generator, val_generator, epochs=50):
    ...
    model_path = os.path.join(checkpoint_path, 'model_epoch_{epoch:02d}_loss_{loss:.2f}_acc_{categorical_accuracy:.2f}_val_loss_{val_loss:.2f}_val_acc_{val_categorical_accuracy:.2f}.h5')
